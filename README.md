...
| `enable_cache_pitr`                       | `bool`                                       | `false`                 | Whether to enable point-in-time recovery for the CloudFront cache DynamoDB table. This allows for recovery of cached data in the event of accidental deletion or other issues, but will incur additional cost. |
| `upload_assets`                           | `bool`                                       | `true`                  | Whether to upload assets to S3. Set to false if you have already uploaded assets or want to manage them separately.                                                                                            |
